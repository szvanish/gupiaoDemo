...
public abstract class Hilt_WatchlistFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WatchlistFragment() {
    super();
  }

  Hilt_WatchlistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WatchlistFragment_GeneratedInjector) this.generatedComponent()).injectWatchlistFragment(UnsafeCasts.<WatchlistFragment>unsafeCast(this));
    }
  }
